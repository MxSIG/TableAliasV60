 ...
 * @author INEGI
 */
public class FiltroEncabezado implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            //System.out.println("Entro a filtroAcceso");
            //Activa control de encabezado
            ControlEncabezado2 conEnc = new ControlEncabezado2(wrappedRequest);
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FiltroAcceso::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FiltroAcceso::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FiltroAcceso::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FiltroAcceso::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FiltroAcceso::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
