 ...
 * @author INEGI
 */
public class BusquedaSqlCreatorLimit implements SqlCreator{
    ...
    public BusquedaSqlCreatorLimit(Table table,String[] valueToSearch, String where, String subProject, String whereTipo ) {
        this.table = table;
