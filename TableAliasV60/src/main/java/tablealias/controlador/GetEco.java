...
import mx.org.inegi.dtweb.denue.delegate.GetEcoDelegated;
 ...
 * @author INEGI
 */
public class GetEco extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            GetEcoDelegated geo = new GetEcoDelegated(conn);
            Gson gson = new Gson();
            List<Datos> s = geo.getInfo(clave);
            String salida = gson.toJson(s);
